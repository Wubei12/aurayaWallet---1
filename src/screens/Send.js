...
import { IconBtn, QRCodeReader } from "../components";
...
const Send = () => {
  ...
  console.log("🚀 ~ Send ~ QAddData:", QAddData);
  console.log("🚀 ~ Send ~ userAddress:", userAddress);

  const checkAdd = QAddData.startsWith("0x");
  console.log("🚀 ~ Send ~ checkAdd:", checkAdd);
  ...
  console.log("🚀 ~ Send ~ hasNfc:", hasNfc);
                ...
                {wait ? (
                  <>
                    ...
                    >
                      ...
                      >
                        Tap the recievers phone or use the QR scanner to
                  ...
                  Amount
                              ...
                              >
                                ...
                                >
                                  ...
                                  >
                                    ...
                                    >
                                      <AnimatedPressable
                                        entering={FadeIn.delay(500).duration(
                                          300
                                        )}
                                        style={{
                                          width: 146.15,
                      ...
                      <>
                        ...
                        >
                          Leave none selected if you don’t have a preffered
                          currency
                        </Animatable.Text>
                        <View
                          style={{
